...
% Google citation
\subsection*{\href{https://scholar.google.com/citations?hl=en&user=Ljk2BvIAAAAJ&view_op=list_works}{Google scholar citation} ({\it h-index}:  \input{gcitation_HIndex.text}\unskip; {\it citations}: \input{gcitation_num.text}\unskip) }

\begin{figure}[h!]
\centering
\includegraphics[width=.605\textwidth]{cs_cite}
